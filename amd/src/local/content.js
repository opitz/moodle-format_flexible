 ...
 *
 * @module     format_flexible/local/content
 * @class      format_flexible/local/content
...
export default class Component extends BaseComponent {
    ...
    create(descriptor) {
        ...
        this.name = 'flexible_course_format';
    ...
    static init(target, selectors, sectionReturn) {
        ...
        function testme() {
            document.addEventListener('click', e => {
                const target = e.target.closest('[data-action="format_flexible/toggle-section"]');
                const cmlist = target.parentElement.previousElementSibling;
//                const num = e.target.getAttribute('data-section');
                if (target) {
                    if (cmlist.style.display === "none") {
                        cmlist.style.display = "block";
                        cmlist.classList.add("d-block");
                        target.innerHTML = 'Show less';
                    } else {
                        cmlist.style.display = "none";
                        cmlist.classList.remove("d-block");
